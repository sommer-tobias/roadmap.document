...
### `r params$genutzt` (`r roundTo(grundwasser$ausbaupfad$genutzt$heizwärme_gwh,10)` GWh)
...
% der maximalen Fördermenge ausgenutzt werden ergibt dies eine Heizenergie von `r roundTo(grundwasser$ausbaupfad$genutzt$heizwärme_gwh,10)` GWh.  
...
### Realistisches Potenzial (`r roundTo(grundwasser$ausbaupfad$realistisch$heizwärme_gwh,10)` GWh)
...
Diese Fördervolumen beträgt `r roundTo(grundwasser$ausbaupfad$realistisch$fördermenge_Miom3, 1)`
...
Mio. m^3^). Mit einer Temperaturdifferenz von `r roundTo(parameters$grundwasser$dT, 1)`
K entsprechen `r roundTo(grundwasser$ausbaupfad$realistisch$fördermenge_Miom3, 1)`
Mio. m^3^ etwa `r roundTo(grundwasser$ausbaupfad$realistisch$umweltwärme_gwh, 10)`
GWh dem Grundwasser entzogener Wärme und einer Heizwärme von `r roundTo(grundwasser$ausbaupfad$realistisch$heizwärme_gwh, 10)`
...
### `r params$ziel` (`r roundTo(grundwasser$ausbaupfad$ziel$heizwärme_gwh, 10)` GWh)
...
ausgeschöpft werden, ergibt dies einen Zielwert von `r roundTo(grundwasser$ausbaupfad$ziel$heizwärme_gwh, 10)` GWh. 
{{< pagebreak >}}
